return {
  -- Telescope
  -- { enabled = false, name = "telescope", "nvim-telescope/telescope.nvim" },
  ...
  -- { enabled = false, name = "telescope-frecency", "nvim-telescope/telescope-frecency.nvim" },
  { enabled = false, name = "telescope-git-file-history", "isak102/telescope-git-file-history.nvim" },
  { enablse = true, name = "telescope-gitignore", "chaosbaby/telescope-gitignore.nvim" },
