return {
  ...
  { enabled = true, name = "asdf", "bry-guy/asdf-lsp.nvim" },
  ...
  { enabled = true, name = "ctrlsf-ui", "P4Cu/ctrlsf-ui.nvim" },
  ...
  { enabled = true, name = "formatter", "seblyng/nvim-formatter" },
  ...
  { enabled = false, name = "md-img-insert", "junaydb/md-img-insert.nvim" },
  ...
  { enabled = true, name = "multicursor", "jake-stewart/multicursor.nvim" },
  ...
  { enabled = false, name = "remote-nvim", "amitds1997/remote-nvim.nvim", lazy = false },
  ...
  { enabled = true, name = "search-replace", "roobert/search-replace.nvim", lazy = false },
  { enabled = true, name = "select-multi-line", "Rasukarusan/nvim-select-multi-line" },
  { enabled = true, name = "sensible", "basilgood/nvim-sensible" },
  { enabled = true, name = "sessions", "natecraddock/sessions.nvim" },
  { enabled = true, name = "session-manager", "The-Plottwist/nvim-session-manager" },
  { enabled = true, name = "smear-cursor", "sphamba/smear-cursor.nvim", lazy = false },
  ...
  { enabled = true, name = "toggleterm.nvim", "akinsho/toggleterm.nvim", lazy = false },
  { enabled = true, name = "tree-remote", "kiyoon/nvim-tree-remote.nvim" },
  { enabled = true, name = "treesj", "Wansmer/treesj" },
  { enabled = true, name = "trouble", "folke/trouble.nvim", lazy = false },
  ...
  { enabled = true, name = "ultimate-autopair", "altermo/ultimate-autopair.nvim" },
  { enabled = true, name = "unception", "samjwill/nvim-unception" },
  { enabled = true, name = "undotree", "jiaoshijie/undotree" },
  { enabled = true, name = "valign", "riku-ri/valign.nvim" },
